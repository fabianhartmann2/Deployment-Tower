...
| Mac mini M4 | 127 x 127 x 50 rounded solid; underside concepts from owner ruler photographs | **Controlled placeholder.** No Mac STEP is claimed. Button, feet, intake, support lands, four clip/cam contact regions, wear pads, native ports, and overmoulds require physical measurement. |
...
| --- | --- | --- | --- |
| `OPEN-02` | Both Wi-Fi antennas: length, hub/stem/taper, radial exit, surface/compressibility, and safe clip lands | 91 long; 30 base; 12 stem; 0.45 radial allowance | Caliper record and 30/30.5/31 mm coupon, then parameter update and 20-cycle test |
...
| `OPEN-04` | Mac button centre/diameter/travel, feet, intake-slot limits, acceptable support lands, clip/cam contact regions, release access, port centres, and actual overmoulds | 13.5 edge offsets; diameter-11 button; 100/112 intake annulus; three 2 mm pads in 1 mm seats; four Z-clips and two linked release rails; 34 plug depth | Caliper/validated scan record, coupon, fully cabled fit, 20 button operations, and clip/release/shake-cycle record |
...
- The three 2 mm Mac base pads occupy 1 mm-deep seats and avoid the photo-derived intake ring and button corner. Four side clip/cams, provisional wear-pad pockets, and two linked bottom-release rails provide positive-Z concept geometry. Final material, compression, preload, force, contact map, scratch protection, shake behavior, and fatigue remain open.
...
| Logo retaining concept (`LOGO-06`) | Four concealed push-in cantilever studs/hooks per panel | Tool-free external replacement without visible fasteners | Geometry implemented; material-specific cycle/rattle test pending |
| Handle (`HDL-07`, `HDL-08`) | Dual sliding T-keys plus lateral squeeze pawls | Positive lock with tool-free installation/removal and no loose normal-use hardware | Mating geometry passes computationally; accidental-release/cycle/load tests pending |
