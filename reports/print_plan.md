...
5. **Wi-Fi dock coupon v2.** Test `coupon_wifi_dock_v2` at 30.0, 30.5, and 31.0 nominal cavities on both actual antennas; one/two/three small marker holes identify those sizes respectively. The rounded noses intrude 0.75 mm per side; the production Ø30.9 mm cavity has a 29.4 mm mouth and requires 0.30 mm nominal motion per arm for the measured Ø30.0 mm hub. Select for hub support, reasonable force, no marks, free cable exit, and 20-cycle behavior—not maximum tightness.
