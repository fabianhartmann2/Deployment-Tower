...
| Cradle, shells, router tray, power box/cover, cap, both pad templates, insert coupon, Mac-button coupon, logo-mount coupon, handle-mount coupon | Modeled orientation, then ground | Warp/adhesion, tie and retention bridges, boss roads, elephant foot, openings, shell stability, pad thickness, and representative insert axes |
