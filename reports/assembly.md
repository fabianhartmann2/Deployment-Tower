...
`grip -> two gusseted legs and full-width stiffening ribs -> two 42 x 32 x 5 mm feet -> four M3x10 screws and blind inserts -> full-depth cap bosses/bearing pads -> integral cap crossmember/ties -> six M4 cap joints (including two over spines) -> upper-shell ribs/ties/spines -> two M4 shell-seam joints -> lower-shell structure/equipment supports`
