...
The current joint labels deliberately distinguish **M3x14 base**, **M3x10 Mac-cradle**, **M3x10 handle**, recessed low-head **M3x6 router-tray**, **M3x8 logo/service/cover**, and **M4x18 cap/seam** stacks. Physical coupons selected Ø4.2 M3 and Ø5.4 M4 insert pilots. The handle screws seat on the full 5 mm feet rather than in deep counterbores. Exact screw heads, engagement, torque, pull-out, and final lengths remain provisional until joint-stack tests pass.
